...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/AlexHmelevskiAG/ALSimplePriorityQueue'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'AlexHmelevskiAG' => 'alexei.hmelevski@gmail.com' }
  s.source           = { :git => 'https://github.com/AlexHmelevskiAG/ALSimplePriorityQueue.git', :tag => s.version.to_s }
